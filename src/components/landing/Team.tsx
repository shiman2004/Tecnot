    ...
    <section className="team-section" id="team">
      <div className="team-container">
        <div className="section-header">
          ...
          <h2>
            Meet the <span className="text-gradient">Minds Behind TECNOT</span>
          </h2>
          <p>
            A passionate team of developers and AI specialists building the future of clinical documentation.
          </p>
        </div>
